...
def compute_augmented_segment_users_df(segment_table_dict: Dict[str,str], ellis_island_users_df: pd.DataFrame, verbose: bool=True, conn: connector=None) -> pd.DataFrame:
    ...
    while True:
        try:
            ...
            # vertically concat the user_uuid_joined_df of this batch into the full augmented_users_df
...
# compute augmented_segment_users for all segment_tables against the same ellis_island_users_df
@timefunc
